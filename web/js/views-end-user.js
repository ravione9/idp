...
/** Official multicolor Google "G" mark for the login SSO button. */
function googleLogoSvg(size = 28) {
  return `<svg class="auth-google-logo" width="${size}" height="${size}" viewBox="0 0 48 48" aria-hidden="true" focusable="false">
