    ...
    async function renderRuns() {
      try {
        ...
        <div class="table-wrap table-wrap--flat"><table class="dense-table">
          <thead><tr><th>Started</th><th>Type</th><th>Status</th><th>Processed</th><th>OK</th><th>Failed</th><th>Progress / Error</th></tr></thead>
          <tbody>${rows}</tbody>
        </table></div>
        ${hasActive ? '<p class="muted" style="font-size:0.82rem;margin:0.75rem 0 0">Live sync in progress — this view refreshes every 5s. Large Google directories (~20k users) can take 30–60 minutes.</p>' : ''}`;
