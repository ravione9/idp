    ...
    const scopedFieldsBlock = useScopeTabs ? `
        ...
        <div id="cfg-pane-scope" class="cfg-pane ds-cfg-pane" style="display:none">
          <p class="ds-cfg-pane-intro">${isGoogle
            ? 'Choose which OUs and users to import. Leave blank to sync the entire directory. <strong>Sync Groups</strong> mirrors Workspace groups into Identity → Groups. Blank/*/ALL auto-all: hourly incremental refreshes a batch of groups; <strong>Full Sync</strong> refreshes every Workspace group.'
