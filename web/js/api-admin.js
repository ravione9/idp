...
Object.assign(api, {
  ...
  userActivationAudit:(params = {}) => f(`/api/admin/audit/user-activation?${new URLSearchParams(params)}`),
  ...
  attendanceIgaGlobalExclusions: () => f('/api/admin/attendance-iga/global-exclusions'),
  addAttendanceIgaGlobalExclusion: (data) => f('/api/admin/attendance-iga/global-exclusions', { method: 'POST', body: JSON.stringify(data) }),
  importAttendanceIgaGlobalExclusions: (csvText) => f('/api/admin/attendance-iga/global-exclusions/import', { method: 'POST', body: JSON.stringify({ csvText }) }),
  deleteAttendanceIgaGlobalExclusion: (id) => f(`/api/admin/attendance-iga/global-exclusions/${id}`, { method: 'DELETE' }),
